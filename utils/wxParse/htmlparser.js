...
let inline = makeMap('abbr,acronym,applet,b,basefont,bdo,big,br,button,cite,del,dfn,em,font,i,iframe,img,input,ins,kbd,label,map,object,q,s,samp,script,select,small,span,strike,strong,sub,sup,textarea,tt,u,var');
...
function HTMLParser(html, handler) {
    ...
    function parseEndTag(tag, tagName) {
        ...
        if (pos >= 0) {
            ...
            for (let i = stack.length - 1; i >= pos; i--) if (handler.end) handler.end(stack[i]);
