        ...
        fee: {
            ...
            observer(newValue) {
                ...
                this.setData({
                    ...
                    totalPriceDispaly: newValue.products_amount ? Number(newValue.products_amount).toFixed(2) : '0.00',
                    membershipReduceFee: newValue.membership_reduce_fee ? Number(newValue.membership_reduce_fee).toFixed(2) : '0.00',
                    discount_code_reduce_fee: newValue.discount_code_reduce_fee ? Number(newValue.discount_code_reduce_fee).toFixed(2) : '0.00',
                });
            }
        },
        shouldGoinDisplay: {
